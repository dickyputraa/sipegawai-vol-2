...
// mencetak string 
$pdf->Cell(250, 7, 'Laporan Gaji', 0, 1, 'C');
...
$pdf->Cell(40, 6, 'Golongan', 1, 0);
$pdf->Cell(40, 6, 'Jam Kerja[Hari]', 1, 0);
$pdf->Cell(40, 6, 'Gaji Perbulan', 1, 1);
...
while ($row = mysqli_fetch_array($get)) {
    ...
    $pdf->Cell(40, 6, $row['jamkerja'], 1, 0);
    $pdf->Cell(40, 6, $row['gaji'], 1, 1);
}
