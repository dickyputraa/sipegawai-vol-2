...
// mencetak string 
$pdf->Cell(250, 7, 'Laporan Pendidikan', 0, 1, 'C');
...
$pdf->Cell(40, 6, 'Tingkat', 1, 0);
$pdf->Cell(40, 6, 'Jurusan', 1, 0);
$pdf->Cell(60, 6, 'Nama Sekolah', 1, 1);
...
while ($row = mysqli_fetch_array($get)) {
    ...
    $pdf->Cell(40, 6, $row['tingkat'], 1, 0);
    $pdf->Cell(40, 6, $row['jurusan'], 1, 0);
    $pdf->Cell(60, 6, $row['namasekolah'], 1, 1);
}
