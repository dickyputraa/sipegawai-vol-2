            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <a type="button" class="w3-button w3-hover-purple w3-border w3-border-purple text-white mb-4" class="nav-link" href="laporan/la.php">
                            Laporan
                        </a>
                        <div class="card mb-4">
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <form method="post">
                                                            ...
                                                            <div class="modal-body">
                                                                <select class="form-control mt-2" name="absen" placeholder="Absen" value="<?= $absen; ?>">
                                                            ...
                                                            <div class="modal-footer">
                                                                <button type="submit" class="btn btn-success" name="editabsen">submit</button>
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <form method="post">
                                                            ...
                                                            <div class="modal-body">
                                                                ...
                                                                <input type="hidden" name="idpg" value="<?= $idpegawai; ?>">
                                                            </div>

                                                            <!-- Modal footer -->
                                                            <div class="modal-footer">
                                                                <button type="submit" class="btn btn-success" name="hapusabsen">submit</button>
                                                                <button type="button" class="btn btn-danger" data-bs-dismiss="modal">Close</button>
                                                            </div>
        ...
        <div class="modal-content">
            ...
            <form method="post">
                ...
                <div class="modal-body">
                    ...
                    <select class="form-control mt-2" name="absen" placeholder="Absen">
                        <option value="">Pilih Absensi</option>
                        <option value="Hadir">Hadir</option>
                        <option value="Izin">Izin</option>
                        <option value="Alpha">Alpha</option>
                ...
                <!-- Modal footer -->
                <div class="modal-footer">
                    <button type="submit" class="btn btn-success" name="tambahabsen">submit</button>
                    <button type="button" class="btn btn-danger" data-bs-dismiss="modal">Close</button>
                </div>
